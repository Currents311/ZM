...
public class BagdeButton extends JButton {
    ...
    private Color badgeColor= new Color(239, 162, 172);
    
    public BagdeButton() {
        setUI(new  BagdeButtonUI());
        setOpaque(false);
    ...
    private class BagdeButtonUI extends BasicButtonUI{

        @Override
        protected void paintText(Graphics grphcs, JComponent jc, Rectangle textRect, String string) {
        }
