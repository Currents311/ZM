...
import com.jdialog.FormGenerateCard;
...
public class FormPelanggan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtGenerate.setText("Cetak Card Member");
        ...
        pnTblLayout.setHorizontalGroup(
            ...
            .addGroup(pnTblLayout.createSequentialGroup()
                ...
                .addGroup(pnTblLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnTblLayout.createSequentialGroup()
                        .addComponent(txtGenerate, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(441, 441, 441)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnTblLayout.createSequentialGroup()
                        .addComponent(lbInfoPage, javax.swing.GroupLayout.PREFERRED_SIZE, 309, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(308, 308, 308)
                    ...
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 947, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void loadData() {
        ...
        List<ModelPelanggan> list =servis.tampilData(posisiAwal, dataPerHalaman);
    ...
    private void pencarianData(){
        ...
        int posisiAwal = pagination.getPosisiAwal();
        int dataPerHalaman = pagination.getDataPerHalaman();
        List<ModelPelanggan> list =servis.pencarianData(keyword, posisiAwal, dataPerHalaman);
        tblModel.setData(list);
    }
    ...
    private void bikinCard() {
        int row = tblData.getSelectedRow();
        if(row != -1){
            ModelPelanggan produk = tblModel.getData(row);
            FormGenerateCard formGenerate = new FormGenerateCard(null, true, row, produk);
            formGenerate.setVisible(true);
            loadData();
        }else{
            JOptionPane.showMessageDialog(null, "Pilih dahulu data yang akan dicetak card member");
        }
    }
}