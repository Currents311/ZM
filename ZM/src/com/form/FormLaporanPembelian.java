...
public class FormLaporanPembelian extends javax.swing.JPanel {
    ...
    private TableModelPembelian tblModelPen = new TableModelPembelian();
    ...
    public FormLaporanPembelian(ModelKaryawan modelKar, String role) {
        initComponents();
        ...
        tblModelPen = new TableModelPembelian(); 
    ...
    if (selectedRange != null && selectedRange.length == 2) {
        ...
        servisReport.printLaporanPembelian(startDate, endDate);
    }
    ...
    if (selectedRange != null && selectedRange.length == 2) {
        ...
        List<ModelPembelian> list = servis.rangeTanggal(startDate, endDate);
