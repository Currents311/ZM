...
public class CurveLineChart extends JComponent {
    ...
    public void addData(ModelChart data) {
        ...
        blankPlotChart.setMaxValues(50); // always use fixed max
    }
    ...
    public void start() {
        if (!animator.isRunning()) {
            ...
            blankPlotChart.setMaxValues(50); // enforce max Y value
            blankPlotChart.getNiceScale().setTickSpacing(5); // enforce tick range of 5
