...
public class DataDetailPembelian extends javax.swing.JDialog {
    ...
    public DataDetailPembelian(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataDetailPembelian dialog = new DataDetailPembelian(new javax.swing.JFrame(), true, null);
    ...
    private void loadData(){
        List<ModelDetailPembelian> list = servis.tampilData(id);
        tblModel.setData(list);
    }
    
    private void pencarianData(){
        List<ModelDetailPembelian> list = servis.pencarianData(id, txtPencarian.getText());
        tblModel.setData(list);
    }
}
