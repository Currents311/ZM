...
import com.tablemodel.TableModelDetailPenjualan;
import java.util.List;
import javax.swing.JFrame;
import javax.swing.JOptionPane;
import javax.swing.table.TableColumnModel;

public class DataDetailPenjualan extends javax.swing.JDialog {

    private TableModelDetailPenjualan tblModel = new TableModelDetailPenjualan();
    private ServiceDetailPenjualan servis = new DetailPenjualanDAO();
    private String id;
    
    public DataDetailPenjualan(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Transaksi > Penjualan > Detail");

        jLabel2.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Data Detail Penjualan");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataDetailPenjualan dialog = new DataDetailPenjualan(new javax.swing.JFrame(), true, null);
    ...
    private void loadData(){
        List<ModelDetailPenjualan> list = servis.tampilData(id);
        tblModel.setData(list);
    }
    
    private void pencarianData(){
        List<ModelDetailPenjualan> list = servis.pencarianData(id, txtPencarian.getText());
        tblModel.setData(list);
    }
}
